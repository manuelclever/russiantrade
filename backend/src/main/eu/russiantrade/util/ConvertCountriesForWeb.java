...
public class ConvertCountriesForWeb {
    ...
    private static void writeJSXSyntax(List<String[]> countries) throws IOException {
        ...
        writer.write("export const countryOptions: Option[] = [\n");
