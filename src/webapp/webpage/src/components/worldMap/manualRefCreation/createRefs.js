...
function getExceptions(iso) {
    ...
    // removed this from json with iso codes:
    // {"Code": "GF", "Name": "French Guiana"},
}

function subtractExceptions(exceptions, country) {
