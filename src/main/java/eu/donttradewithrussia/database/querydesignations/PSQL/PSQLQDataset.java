...
public class PSQLQDataset extends PSQLQueries {
    ...
    public static final String QUERY_DELETE_WHERE_REPORTER_AND_PERIOD_AND_COMMOTIDY = MONTHLY_TRADE_DELETE + WHERE +
    ...
    public static final String QUERY_DELETE_WHERE_REPORTER_AND_PERIOD_AND_COMMOTIDY_BETWEEN =
