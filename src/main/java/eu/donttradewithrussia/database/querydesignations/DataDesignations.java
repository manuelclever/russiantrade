...
public abstract class DataDesignations extends SQLQueries {
    ...
    public static final String COALITION = "collection";
    public static final String COUNTRY = "country";

    //local
    public static final String TABLE_COALITION = "coalition";
    public static final String COALITION_ID = TABLE_COALITION + ID;
    ...
    public static final String TABLE_UNION = "union";
